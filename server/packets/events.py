...
class Events(Collection):
    def __init__(
        self, server: GameServer, items_data: ItemsData, player_tribute: PlayerTribute
    ) -> None:
        super().__init__()
    ...
    async def on_login_request(self, ctx: ServerContext) -> None:
        ...
        packet = GameUpdatePacket(
            update_type=GameUpdatePacketType.CALL_FUNCTION, variant_list=variant_list
        )
